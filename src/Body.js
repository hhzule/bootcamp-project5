...
import img1 from './bc.gif';
import img2 from './ai.gif';
import img3 from './iot.gif';
import img4 from './qc.gif';
import img5 from './cs.gif';
...
function Body(){
    return(
        ...
        <div>
         ...
         <Slide left >
         Learn the technologies that shape oue future
        </Slide>
        </LightSpeed>
...
<h1>
        ...
        <LightSpeed left cascade>
         <Slide left cascade>
         <p>Learn More About This Rapidly Advancing Technology and Its Impact on the Internet. Stay Up to Date with the Changes and Advancements Made to Blockchain Technology. </p>
        </Slide>
        </LightSpeed>
